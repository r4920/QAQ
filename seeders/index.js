...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'Fc4jZF7i43DMNH_',
      'isDeleted':false,
      'username':'Willie_Gorczany',
      'email':'Birdie0@yahoo.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Willie_Gorczany' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'oJ6a1Oll7w6kKR0',
      'isDeleted':false,
      'username':'Cleo45',
      'email':'Sydni.Gusikowski@yahoo.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Cleo45' }, userToBeInserted,  { upsert: true });
