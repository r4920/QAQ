...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Shaun88',
      password: 'UKnwAkdcQxW2TWq',
      email: 'Abbie.Jakubowski@hotmail.com',
      name: 'Reginald Ortiz',
      userType: 543,
      mobileNo: '(486) 908-0565',
      resetPasswordLink: {},
      loginRetryLimit: 106,
      loginReactiveTime: '2022-11-19T14:02:59.840Z',
      id: '6298b5864af6880f4f0e486f'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Emery.Towne',
        'password':'_o8lWtS0X5FXAGD',
        'email':'Alf56@hotmail.com',
        'name':'Wendy Stanton',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(267) 462-5577',
